...
class Reports extends USER_Controller
{
    ...
    public function index()
    {
        ...
        $data['issuedInvoices'] = $this->ReportsModel->getIssuedInvoices(strtotime($_GET['from_date']), strtotime($_GET['to_date']), $showDraft, $_GET['payment_status']);
        $data['issuedInvoicesByMonth'] = $this->ReportsModel->getIssuedInvoicesByMonth($_GET['from_date'], $_GET['to_date'], $showDraft, $_GET['payment_status']);
        $data['topClients'] = $this->ReportsModel->getTopClients($_GET['from_date'], $_GET['to_date'], $showDraft, $_GET['payment_status']);
