...
$lang['limit_inv_error'] = 'Вие сте изчерпали лимита си за създаване на фактури. Ако искате да издадете фактура ще трябва да подновите плана си.';
...
$lang['exceeded_limit_firms'] = 'Вашият лимит за използване на фирми е превишен. Моля изтрийте някоя от фирмите за да продължите работата си в сайта. Това изтриване няма да бъде перманентно и при преминаване на по-голям план ще имате възможност за възстановяване на фирмата.';